...
//冒泡提示 显示完隐藏
+ (MB_INSTANCETYPE)showHUDAddedToExt:(UIView *)view showMessage:(NSString*)showMessage  yOffset:(float)yOffset afterDelay:(NSTimeInterval)delay animated:(BOOL)animated
{
...
//冒泡提示 显示完隐藏,小字体
+ (MB_INSTANCETYPE)showHUDAddedSmallToExt:(UIView *)view showMessage:(NSString*)showMessage  yOffset:(float)yOffset afterDelay:(NSTimeInterval)delay animated:(BOOL)animated
{
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:view animated:animated];
	
	// Configure for text only and offset down
	hud.mode = MBProgressHUDModeText;
	hud.detailsLabelText = showMessage;
...
//冒泡提示 显示完隐藏
+ (MB_INSTANCETYPE)showHUDAddedToExt:(UIView *)view showMessage:(NSString*)showMessage   afterDelay:(NSTimeInterval)delay animated:(BOOL)animated
{
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:view animated:animated];
...
+ (MB_INSTANCETYPE)showHUDAddedToExt:(UIView *)view showMessage:(NSString*)showMessage animated:(BOOL)animated {
	MBProgressHUD *hud = [[self alloc] initWithView:view];
    hud.labelText=showMessage;
	[view addSubview:hud];
